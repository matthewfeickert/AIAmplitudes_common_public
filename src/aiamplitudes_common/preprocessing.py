...
import random
from aiamplitudes_common.rels_utils import get_coeff_from_word,check_slot,find_all,alphabet,count_appearances
from aiamplitudes_common.commonclasses import fastRandomSampler
