from aiamplitudes_common.file_readers import relpath,convert,get_relpermdict
from aiamplitudes_common.polynomial_utils import polynom_convert, get_runpolynomials, get_polynomialcoeffs
from aiamplitudes_common.fbspaces import get_frels,get_brels,get_perm_fspace,get_perm_bspace
from aiamplitudes_common.fbspaces import get_rest_fspace,get_rest_bspace
from aiamplitudes_common.rels_utils import alphabet,quad_prefix
# fixed alphabet
